...
BASE_DRIVE_PATH = "/workspace/TFF_Docs" 
PERSIST_DIRECTORY = "/workspace/local_chroma_db"

# NOTE: Ensure your local model (vLLM/Ollama) is actually running on port 1234 inside the pod
